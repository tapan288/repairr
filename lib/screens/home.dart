...
import 'package:food_app_concept/widgets/popular_food.dart';
...
class _HomeState extends State<Home> {
  ...
  void didChangeDependencies() {
    if (initialRun) {
      Provider.of<Services>(context).fetchRecentProducts();
      initialRun = false;
    }
              ...
              child: ListTile(
                ...
                title: TextField(
                  decoration: InputDecoration(
                      hintText: "Find services", border: InputBorder.none),
                ),
                trailing: Icon(
                  Icons.filter_list,
                  color: red,
